...
@Composable
fun TeamModeScreen (navController: NavController) {
    Scaffold(
        topBar = {
            TopBar("Modo Trabajo en equipo")
        },
        bottomBar = {
        ...
        TeamModeContent(paddingValues)
    }
}

@Composable
fun TeamModeContent(paddingValues: PaddingValues) {
    ...
    Column(
        ...
        Text(text = "Modo Trabajo en equipo")
    }
