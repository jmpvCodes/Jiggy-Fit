...
@Composable
fun DailyModeScreen (navController: NavController) {
    Scaffold(
        topBar = {
            TopBar("Modo Reto diario")
        },
        bottomBar = {
        ...
        DailyModeContent(paddingValues)
    }
}

@Composable
fun DailyModeContent(paddingValues: PaddingValues) {
